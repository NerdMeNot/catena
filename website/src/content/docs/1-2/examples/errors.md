---
title: "Errors"
description: "`Try`: one parse pipeline, three error policies, `WrapErr`, `Recover`"
sidebar:
  order: 4
---
...
[View on GitHub](https://github.com/NerdMeNot/catena/blob/main/examples/04-errors/main.go)
