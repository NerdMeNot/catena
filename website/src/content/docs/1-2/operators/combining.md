---
title: "Combining"
description: "Putting two or more sequences together, or pairing a sequence with itself. Concat and Chain are lazy in both operands; Zip pulls its second operand, and the set operations buffer theirs."
sidebar:
  order: 5
---
