---
title: "Concepts"
description: "catena is small in concept count: four types, a naming law, and a handful of package-wide rules that hold everywhere. Once you know these, every operator's behavior is predictable from its name and doc comment."
sidebar:
  order: 2
---
...
[examples/01-basics](/examples/basics/) runs the same two
