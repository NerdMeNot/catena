---
title: "Performance"
description: "The promise is precise: any overhead catena carries beyond a hand-written loop belongs to Go's iterator protocol, not to the library — and that claim is measured, not asserted."
sidebar:
  order: 5
---
